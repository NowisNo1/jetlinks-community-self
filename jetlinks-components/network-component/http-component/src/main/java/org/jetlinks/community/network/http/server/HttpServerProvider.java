...
public class HttpServerProvider implements NetworkProvider<HttpServerProperties> {
    ...
    public HttpServerProvider(CertificateManager certificateManager, Vertx vertx, PayloadParserBuilder payloadParserBuilder) {
    ...
    private void initHttpServer(VertxHttpServer httpServer, HttpServerProperties properties) {
        ...
        httpServer.setParserSupplier(() -> payloadParserBuilder.build(properties.getParserType(), properties));
