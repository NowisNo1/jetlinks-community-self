...
import org.jetlinks.community.network.http.parser.strateies.DelimitedPayloadParserBuilder;
import org.jetlinks.community.network.http.parser.strateies.DirectPayloadParserBuilder;
import org.jetlinks.community.network.http.parser.strateies.FixLengthPayloadParserBuilder;
...
@Component
public class DefaultPayloadParserBuilder1 implements PayloadParserBuilder, BeanPostProcessor {

    private Map<PayloadParserType, PayloadParserBuilderStrategy> strategyMap = new ConcurrentHashMap<>();

    public DefaultPayloadParserBuilder1(){
